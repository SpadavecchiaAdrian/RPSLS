...
all_layers_model = tf.keras.Sequential([
    base_model2,
...
all_layers_model.compile(optimizer=optimizer,
                         loss=tf.keras.losses.categorical_crossentropy,
                         metrics=["accuracy"])


print(all_layers_model.summary())
...
history = all_layers_model.fit_generator(train_generator,
...
all_layers_model.save("rpslsAllLayers.h5")
